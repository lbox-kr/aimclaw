...
description: Slack 메시지를 짧고 자연스러운 대화체와 최신 표준 Markdown, Block Kit 카드, 버튼, reaction, thread에 맞게 설계한다. Slack에서 상태·근거·다음 행동이 섞인 작업 결과를 정리하거나 요약·선택 UI를 구성할 때 사용한다.
---
...
- 결론과 영향을 먼저 말하고 필요한 근거·다음 행동·링크만 남긴다.
- 원시 로그, 긴 경로, 내부 작업 과정은 요약하고 확인되지 않은 성공을 예고하지 않는다.
